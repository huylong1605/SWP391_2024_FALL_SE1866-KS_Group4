...
<div class="container-fluid home-manager">
  <div class="item-nav-manager d-flex justify-content-center">
    <a href="${pageContext.request.contextPath}/Views/Admin/accountManage" class="items-nav-manager">
      Manage Account
    </a>
    <a href="${pageContext.request.contextPath}/Views/Admin/notifications" class="items-nav-manager">
      Manage Notification
    </a>
  </div>
