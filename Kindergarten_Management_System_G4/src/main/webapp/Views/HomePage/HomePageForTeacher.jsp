...
<div class="hero_area">
    <!-- slider section -->
    <div class="text-center"><h2>Welcome Teacher</h2></div>
    <section class=" slider_section position-relative" style="padding-bottom: 100px">
        <div class="container row">
            <div id="carouselExampleIndicators" class="carousel slide col-md-6" data-ride="carousel" style="">
                <div class="parent-items">
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/teacher/applications" class="items-nav-manager text-light">
                            Manage Application
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/teacher-subject" class="items-nav-manager text-light">
                            View Subjects
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/teacher-term" class="items-nav-manager text-light">
                            View Semester
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/Views/Teacher/teacherSchedule?teacherId=${sessionScope.user.userID}" class="items-nav-manager text-light">
                            View Schedule
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a class="items-nav-manager text-light" href="${pageContext.request.contextPath}/parent-notification">
                            NEWS
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/teacher/evaluations/list" class="items-nav-manager text-light">
            ...
            <div class=" col-md-6">
                <img src="${pageContext.request.contextPath}/img/choosing-the-right-kindergarten.jpg" style="width: 800px;height: 450px; border-radius: 10px" alt="">
            </div>
        </div>
    </section>
    <!-- end slider section -->
