            ...
            <div id="carouselExampleIndicators" class="carousel slide col-md-6" data-ride="carousel" style="">
                <div class="parent-items">
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/listClass" class="items-nav-manager text-light">
                            Manage Class
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/Views/Manager/listRoom" class="items-nav-manager text-light">
                            Manage Room
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/viewStudentList" class="items-nav-manager text-light">
                            View List Student
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/classLevel" class="items-nav-manager text-light">
                            Manage Class Level
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/view-extracurricular-activities" class="items-nav-manager text-light">
                            Manage Activity
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/listSchedule" class="items-nav-manager text-light">
                            Manage Schedule
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/term" class="items-nav-manager text-light">
                            Manage Term
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/subject" class="items-nav-manager text-light">
                            Manage Subject
                        </a>
                    </button>
                    <button class="btn btn-primary" style="width: 40%">
                        <a href="${pageContext.request.contextPath}/Views/Manager/AddStudent_ChangeClass.jsp" class="items-nav-manager text-light">
                            Add/Change Class For Student
                        </a>
                    </button>
                </div>
            </div>
