                    ...
                    <div class="col-12">
                        <div class="card my-4">
                            ...
                            <div class="container table-container">
                               ...
                               <div>
                                   <a class="btn btn-primary" href="${pageContext.request.contextPath}/Views/Manager/StudentDontHaveClass">Student Not Have Class</a>
                                   <a class="btn btn-primary" href="#">Student Had Class</a>
                               </div>
                            </div>
                        </div>
                    </div>
