                    ...
                    <c:forEach var="notification" items="${notifications}">
                      <tr>
                        ...
                        <td class="align-middle">
                          <a href="${pageContext.request.contextPath}/viewNotification?id=${notification.notificationId}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="View notification">
                            View
                          </a>
                          |
                          <a href="${pageContext.request.contextPath}/editNotification?id=${notification.notificationId}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit notification">
                            Edit
                          </a>
                          |
                          <a href="#"
