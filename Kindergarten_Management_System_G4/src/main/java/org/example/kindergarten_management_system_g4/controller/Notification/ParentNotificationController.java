 ...
 * 10/1/2024       1.1                    Vũ Gia Huy                      Initial creation of ParentNotificationController
 */
...
/**
 * Lớp ParentNotificationController phục vụ các yêu cầu liên quan đến việc hiển thị danh sách
 * thông báo dành cho phụ huynh trong hệ thống.
 *
 * <p>Lỗi: Không có lỗi nào được biết đến</p>
 *
 * <p>URL: /parent-notification</p>
 *
 * @see NotificationDAO
 * @see Notification
 */
@WebServlet(name = "ParentNotificationController", value = "/parent-notification")
public class ParentNotificationController extends HttpServlet {
    ...
    /**
     * Phương thức doGet để xử lý các yêu cầu GET, lấy danh sách thông báo và hiển thị trên trang phụ huynh.
     *
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Chuyển tiếp yêu cầu và phản hồi tới trang JSP để hiển thị danh sách thông báo
            request.getRequestDispatcher("ParentNewsList.jsp").forward(request, response);
