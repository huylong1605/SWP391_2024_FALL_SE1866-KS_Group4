...
//    }
    ...
    public List<Term> filterTerms(String termName, String startDate, String endDate, String year) {
        ...
        try (PreparedStatement statement = this.connection.prepareStatement(sql)) {
            ...
            if (startDate != null && !startDate.isEmpty()) {
                statement.setDate(paramIndex++, java.sql.Date.valueOf(startDate)); // Chuyển đổi String sang Date
            }
            if (endDate != null && !endDate.isEmpty()) {
                statement.setDate(paramIndex++, java.sql.Date.valueOf(endDate)); // Chuyển đổi String sang Date
            }
            if (year != null && !year.isEmpty()) {
                statement.setInt(paramIndex++, Integer.parseInt(year)); // Chuyển đổi String sang int
            }
